	...
	<view class="content">
		...
		<view class="goods-box">
			...
			<view class="goods-piece">
				<view class="piece">
					<view class="piece-pre">10人成团</view>
		...
		<view class="spell-box">
			<u-cell-item  title="这些人正在拼单，可直接参与" :arrow="true" value="查看更多" arrow-direction="arrow-right" class="u-cell-item"></u-cell-item>
		...
		<!-- 底部弹窗 -->
		<u-popup v-model="show" mode="bottom" height="750rpx" closeable="true">
