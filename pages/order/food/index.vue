		...
		<view class="order-box">
			<view class="order-list" v-for="(item,index) in order" :key="index">
				<view class="order-list-top">
					...
					<view class="order-state" style="color: #FF0000;" v-if="item.state==1">已发单</view>
					<view class="order-state" style="color: #FF0000;" v-if="item.state==2">待付款</view>
					<view class="order-state" style="color: #FF0000;" v-if="item.state==2">支付完成</view>
		...
		data() {
			return {
				...
				order:[
						...
						goods_name:"【特产】黄水粑4只装",
						state:1,
						goods_img:"../../../static/banner.png",
						goods_food:"【特产】黄水粑4只装",
